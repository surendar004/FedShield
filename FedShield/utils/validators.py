"""Input validation and sanitization utilities for FedSIG+ signatures."""
import os
import sys
...
try:
    ...
    def get_config():
        class Config:
            QUARANTINE_DIR = os.path.join(ROOT_DIR, 'data', 'quarantined')
        return Config()
...
def sanitize_input(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    allowed_fields = {
        ...
        'quarantined_path', 'id', 'received_at', 'threat_type', 'threat_name'
    }
